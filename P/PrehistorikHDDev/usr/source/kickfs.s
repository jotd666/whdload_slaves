...
; 14 bn_SIZEOF
	...
	IFND HD_Cyls
HD_Cyls			= 80	; value for a floppy disk
	ENDC
HD_Surfaces		= 2
...
.a_delete_object
	...
	;a directory
		lea	(mfl_fib,a0),a0
		WHD_CALL	resload_ExNext,a2
		tst.l	d0
		bne	.delete_dirnotempty
		move.l	d7,a0
.delete_do	move.l	(fl_Key,a0),a0
		WHD_CALL	resload_DeleteFile,a2
		move.l	d7,d0
		bsr	.unlock
		bra	.reply1true
...
.read_nospec	move.l	(dp_Arg1,a4),a0
	...
	;read direct
		...
		WHD_CALL	resload_LoadFileOffset,a2
	;finish
...
.write1		move.l	(fl_Key,a0),a0			;name
		move.l	(dp_Arg2,a4),a1			;buffer
		WHD_CALL	resload_SaveFileOffset,a2
