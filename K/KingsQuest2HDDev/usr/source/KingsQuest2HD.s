...
PROTECTED_SIERRA = 87136
UNPROTECTED_KQ2 = 134852
...
.done	
	...
	bsr	check_version       ; loads proper program name in A0
    lea exe_size(pc),a1
    move.l  d0,(a1)
...
patch_main   
    ...
    move.l  exe_size(pc),d0
    cmp.l   #PROTECTED_SIERRA,d0
    beq.b   .protected
    ; not protected
...
.out
    ...
    move.l  d7,a1
    move.l  _resload(pc),a2
    lea pl_main_protected(pc),a0
    jsr resload_PatchSeg(a2)
    
	rts

; ripped from the decrypting part, exactly the same table is in
; kings quest the first opus
offset_table
