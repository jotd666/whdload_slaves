...
_update_buttons_status:
		movem.l	d0/a0/a1,-(a7)
		lea	_current_buttons_state(pc),a0
		lea	_previous_buttons_state(pc),a1
		bsr	_read_joystick_port_1
		move.l	(a0),(a1)		; store previous value
		move.l	d0,(a0)			; store current value
		movem.l	(a7)+,d0/a0/a1
		rts
		
_current_buttons_state:
	dc.l	0
_previous_buttons_state:
	dc.l	0
