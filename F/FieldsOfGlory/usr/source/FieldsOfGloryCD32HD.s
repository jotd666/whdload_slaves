;*---------------------------------------------------------------------------
;  :Program.	FieldsOfGloryCD32HD.asm
;  :Contents.	Slave for "FieldsOfGlory CD³²" from 
;  :Author.	JOTD
;  :Original	v1 jffabre@free.fr
;  :Version.	$Id: FieldsOfGloryCD32HD.asm 0.5 2000/11/26 21:13:41 jah Exp $
...
;---------------------------------------------------------------------------*
	...
	IFD BARFLY
	OUTPUT	"FieldsOfGloryCD32.slave"
...
_data		dc.b	"data",0
_name		dc.b	"Fields Of Glory CD³²",0
_copy		dc.b	"1994 Microprose",0
_info		dc.b	"Install/fix by JOTD",10
		dc.b	"Version 1.0 "
	IFD BARFLY
		INCBIN	"T:date"
	ENDC
