	; James Pond imager (derived from Mr Larmer "The Blues Brothers" imager)
    ...
    ; this is actually Atari-ST native format
	...
	;                  Blues Brothers (Titus) (uses exactly the same format)
	
	; Disk map:
	;
	; track 0: dos, boot
	; track 1: protection
	; tracks 2-77,82-159: MFM data
	; tracks 78-81: DOS, root block & startup files
	; disk is seen as DOS by the OS

		incdir	Include:
		include	RawDIC.i

		OUTPUT	"JamesPond.islave"
		...
		dc.b	"$VER: "
Text:		dc.b	"James Pond imager V1.0",10,"by JOTD (Blues Brothers islave by Mr.Larmer)",0
		cnop	0,4
...
TL_1:
	; side 0
		TLENTRY	2,76,TRACK_LEN,SYNC_STD,DMFM_NR
		TLENTRY	78,80,TRACK_LEN,SYNC_STD,DMFM_NULL	; dos tracks
		TLENTRY 82,158,$1400,SYNC_STD,DMFM_NR
	; side 1
		TLENTRY	3,77,TRACK_LEN,SYNC_STD,DMFM_NR
		TLENTRY	79,81,TRACK_LEN,SYNC_STD,DMFM_NULL	; dos tracks
		TLENTRY 83,159,$1400,SYNC_STD,DMFM_NR
