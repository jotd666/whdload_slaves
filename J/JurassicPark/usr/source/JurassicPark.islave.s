		...
		; Rob Northen PDos imager (Barfly/vasm assembler source)
		;
		...
		;
		; Jurassic Park              $4e714e75 - All disks
		;
...
.passchk
		...
		dc.b	"$VER:"
Text		dc.b	"Jurassic Park PDos imager V1.0",10
		dc.b	"by Codetapper/Action & JOTD"
		dc.b	0
		cnop	0,4
...
DSK_1		dc.l	DSK_2		; Pointer to next disk structure
		...
		dc.w	0		; Disk flags
		dc.l	TL_0		; List of tracks which contain data
		dc.l	0		; UNUSED, ALWAYS SET TO 0!
		dc.l	disk1_files	; List of files to be saved
...
DSK_3		dc.l	DSK_4		; Pointer to next disk structure
		...
		dc.l	0		; Called before a disk is read
		dc.l	0		; Called after a disk has been read
DSK_4		dc.l	0		; Pointer to next disk structure
		dc.w	1		; Disk structure version
		dc.w	0		; Disk flags
		dc.l	TL_1		; List of tracks which contain data
		dc.l	0		; UNUSED, ALWAYS SET TO 0!
...
TL_0	TLENTRY	000,000,$1600,SYNC_STD,DMFM_STD
TL_1
		TLENTRY	002,159,$1800,$1448,_DMFM_RNPDos_D1
		TLEND

; this mimmicks the legacy separated images (renamed as disk.0, disk.1)
disk1_files
	FLENTRY	disk0,0,$1600
	FLENTRY	disk1,$1600,158*$1800
	FLEND
...
_DMFM_RNPDos_D1
		move.l	#$4e714e75,d6			;d6 = Disk key for disk 1
		bra	_RN_PDos
