...
_060_real_ovfl:
	...
	move.w		#$6000,$2(sp)
	frestore	(sp)+
	bra.l		trap	; jump to trap handler
...
_060_fpsp_snan:
	bra.l		_FP_CALL_TOP+$80+$00

	;|.global		_060_fpsp_operr
_060_fpsp_operr:
	bra.l		_FP_CALL_TOP+$80+$08

	;|.global		_060_fpsp_ovfl
_060_fpsp_ovfl:
	bra.l		_FP_CALL_TOP+$80+$10

	;|.global		_060_fpsp_unfl
_060_fpsp_unfl:
	bra.l		_FP_CALL_TOP+$80+$18

	;|.global		_060_fpsp_dz
_060_fpsp_dz:
	bra.l		_FP_CALL_TOP+$80+$20

	;|.global		_060_fpsp_inex
_060_fpsp_inex:
	bra.l		_FP_CALL_TOP+$80+$28

	;|.global		_060_fpsp_fline
_060_fpsp_fline:
	bra.l		_FP_CALL_TOP+$80+$30

	;|.global		_060_fpsp_unsupp
_060_fpsp_unsupp:
	bra.l		_FP_CALL_TOP+$80+$38

	;|.global		_060_fpsp_effadd
_060_fpsp_effadd:
	bra.l		_FP_CALL_TOP+$80+$40
