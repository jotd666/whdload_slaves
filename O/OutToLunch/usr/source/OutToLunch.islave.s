...
.passchk
		...
		dc.b	"$VER:"
Text		dc.b	"Out To Lunch PDos imager V1.0",10
...
TL_1		
		TLENTRY	002,085,$1800,$1448,_DMFM_RNPDos_D1
		TLEND
TL_2		
		TLENTRY	002,136,$1800,$1448,_DMFM_RNPDos_D1
		TLEND

;======================================================================

_DMFM_RNPDos_D1	moveq.l	#$0,d6			;d6 = Disk key for disk 1
		bra	_RN_PDos
