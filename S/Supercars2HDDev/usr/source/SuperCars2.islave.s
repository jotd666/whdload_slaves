		...
		;         Tracks 002-157: Sync ($4489), length $1800 bytes
		;
		; Disk 2: Tracks 002-151: Sync ($4489), length $1800 bytes

		incdir	include:
		include	RawDIC.i

		OUTPUT	"SuperCars2.islave"
		...
		dc.b	"$VER:"
Text		dc.b	"Super Cars 2 imager V1.0",10
...
TL_1		TLENTRY 002,157,$1800,SYNC_STD,_RipTrack
		TLEND
		EVEN

TL_2		TLENTRY 002,151,$1800,SYNC_STD,_RipTrack
		TLEND
		EVEN
