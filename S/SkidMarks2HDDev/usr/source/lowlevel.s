* $Id: lowlevel.s 1.2 2003/02/19 07:43:29 wepl Exp $
...
.port0
	move.l	OSM_PORTS_CONFIG(pc),D0	; type of controller connected (see osemu.asm)

	move.l	a6,-(sp)
	lea	(joy0dat,a5),A6		; joystick 1 moves
	bsr	.joy_test
	move.l	(sp)+,a6
...
.port1
	move.l	OSM_PORTS_CONFIG+4,D0	; type of controller connected (see osemu.asm)

	move.l	a6,-(sp)
	lea	(joy1dat,a5),A6		; joystick 2 moves
	bsr	.joy_test
	move.l	(sp)+,a6
