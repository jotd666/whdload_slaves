...
$(PROGNAME)CDTV.slave : $(SOURCE)
	wdate.py> datetime
	vasmm68k_mot -DCDTV -DDATETIME -IK:/jff/AmigaHD/amiga39_JFF_OS/include -I$(WHDBASE)\Include -I$(WHDBASE)\Src\sources\whdload -phxass -nosym -Fhunkexe -o $(PROGNAME)CDTV.slave $(SOURCE)
