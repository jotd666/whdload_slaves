...
jump_1000
    ...
    ; skip all save context code, keep our stack in fastmem
	jmp	$1050.W
...
; that was because of stupid movem with A7 as target!
...
pl_menu:
    ...
    ; stupid MOVEM.L D0-D7/A0-A7,-(A7)
    ; or (A7)+,D0-D7/A0-A7 which makes no sense
    ; and crashes on 68020+ (but okay on 68000/68010)
    ; replaced by D0-D7/A0-A6
    ; the 2 couple of occurrences below work fine with that
    ...
    ; but if we do that below, the music doesn't work anymore
    ; probably because at some point it pokes at a saved register
    ; assuming the offset in the stack... grrrrr. So we have to emulate
    ; the stack depth, which requires jmps, not jsrs for register save
    ; register restore isn't a problem
    
    ;PL_P $7BFE,store_regs_7BFE
    ;PL_P $07c62,restore_regs

    ;PL_P    $74CC,store_regs_74CC
    ;PL_P    $765E,restore_regs
    PL_I    $7668   ; this seems unreached
;    PL_P    $7668,restore_regs
    
    ;PL_P $07d6e,restore_and_flush
	PL_END
    
store_regs_7BFE
	MOVEM.L	D0-D7/A0-A6,-(A7)	;074cc: 48e7ffff
    subq.l  #4,a7
    lea $8040,a6
    jmp     $07c06
...
pl_21000
    ...
    ; stupid movem to/from A7 shit continues, probably music/sfx
    ; code 100% identical to the one in the menu, just different addresses
    ...
    PL_P $2A022,store_regs_2A022
    PL_P $2A1B4,restore_regs
    PL_I    $2A1BE   ; this seems unreached
   
    PL_P $2A754,store_regs_2A754
    PL_P $2A7B8,restore_regs
    
    PL_P $2A8C4,restore_and_flush
